	...
	<div class="desh-main-content">
		<br>
			...
			echo '<div class="widget">
					...
					<div class="chart"> '.($sentamount['sentamount']-$receivedamount['receivedamount']).' EGP</div>
				</div>
				<div class="widget">
					<div class="title">Send Money</div>
					<div class="chart"> '.$sentamount['sentamount'].' EGP</div>
				</div>
				<div class="widget">
					<div class="title">Receive Money</div>
					<div class="chart">'.$receivedamount['receivedamount'].' EGP</div>
				</div>'
				;
				/*
				<div class="widget">
