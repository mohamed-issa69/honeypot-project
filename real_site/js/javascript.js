function chkpass(){
	...
	function checkphn(){
		...
		if (!testsphone && sphone.length > 0 ) {
			document.getElementById("sphneror").innerHTML = "Please enter a valid Egyptian phone number!";
		...
		if (!testrphone && rphone.length > 0) {
			document.getElementById("rphneror").innerHTML = "Please enter a valid Egyptian receiver number!";
